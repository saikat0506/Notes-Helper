/* Create a class called Rectangle with attributes length and width. Write a program to calculate and display the area of a rectangle using the Rectangle class. */
