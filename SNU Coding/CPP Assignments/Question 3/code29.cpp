/* Create a class called Time with attributes hours and minutes. Write a program to create an object of the Time class, set its attributes, and display the time. */
