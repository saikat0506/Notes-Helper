/*
Create a base class Shape with a virtual function area(). Create two derived classes, Circle and Rectangle, from Shape, each overriding the area() function to calculate its specific area. Write a program to create an array of pointers to Shape objects, populate it with instances of Circle and Rectangle, and call the area() function for each object.[ Polymorphism with Pointers to Base Class ]
*/
